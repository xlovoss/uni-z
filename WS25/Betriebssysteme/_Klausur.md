...
- Aufgaben Betriebssystem (Was sind Betriebsystem (Betrieb des Systems das es möglich macht das alle mal ran dürfen), Verwaltung, was zählt dazu)
...
- Polling (man fragt die ganze Zeit nach) und weitere Aufgaben auf den Folien
- Unterscheidung Prozess (Aktivät eines Programms) und Programm ( Ausführbarbare Datei )
...
- Was ist ein Interrupt, wie Funktioniert er, Was passiert da, was kann man tun wenn einer passiert (synchron und asynchron )
...
- Logik von MMU 
- Mehrstufige Seitentabelle ist so wie ein I-Node (sind wie FATs nur I-Nodes sind mehrere einzelne Tabelle)
...
- FAT (Eine Massive Liste, Großer Block für alles )
